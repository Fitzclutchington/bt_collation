...
cdf = netCDF4.Dataset("../../sst_approximation/data/2017-01-10/20170110160000-STAR-L2P_GHRSST-SSTsubskin-AHI_H08-ACSPO_V2.41-v02.0-fv01.0.nc")
...
ax1 = plt.subplot(121)
img1 = ax1.imshow(bt_3_mask,vmin=0.3,vmax=1)
...
print "3 bt mask = " + str(bt_3_mask[4270,1547])
print "3 bt mask = " + str(bt_3_mask[4270,1543])
print "3 bt mask = " + str(bt_3_mask[4269,1542])